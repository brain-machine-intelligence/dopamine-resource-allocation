...
[acqPE] = TD_noCS2 (para, round(x*0.1));
acqPEno2 = acqPE;
...
[acqPE] = TD_noCS2 (para, round(x*0.8));
acqPEno2late = acqPE;

figure(2); clf;
subplot(1,2,1); plot(k, acqPEno2(round(x*0.1),:), '--k', k, acqPE2(round(x*0.1),:), '-k', 'LineWidth', 1.5); 
xlim([1 15]); xticks([1 5 10 15]); ylim([-0.05 0.5]); hold on; 
plot ([1 5 15], [0 0 0], 'k'); 
subplot(1,2,2); plot(k, acqPEno2late(round(x*0.8),:), '--k', k, acqPE2(round(x*0.8),:), '-k', 'LineWidth', 1.5);
xlim([1 15]); xticks([1 5 10 15]); ylim([-0.05 0.5]); ylim([-0.05 0.5]); hold on; 
plot ([1 5 15], [0 0 0], 'k'); 
...
plot(k,acqPE(round(x*0.1),:), 'Color', [0.6,0.6,0.6], 'LineWidth', 1.5); xlim([1 15]);hold on; 
plot(k,acqPE(round(x*0.2),:), 'Color', [0.3,0.3,0.3], 'LineWidth', 1.5); hold on; 
plot(k,acqPE(round(x*0.8),:), 'Color', [0 0 0], 'LineWidth', 1.5); hold off;
